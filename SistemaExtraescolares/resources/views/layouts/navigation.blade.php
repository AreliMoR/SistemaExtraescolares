        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                    {{ Auth::user()->user_type === 'admin' || Auth::user()->user_type === 'instructor' ? __('Alumnos') : __('Inicio') }}
                </x-nav-link>

                    <x-nav-link :href="route('directivos')" :active="request()->routeIs('directivos')">
                        {{ __('Directivos') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('instructores.index')" :active="request()->routeIs('instructores.index')">
                        ...
                        <x-nav-link :href="route('talleres.index')" :active="request()->routeIs('talleres.create')">
                            {{ __('Talleres') }}
                        </x-nav-link>
                    @endif
                </div>
